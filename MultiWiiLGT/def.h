...
#if defined(BI) || defined(TRI) || defined(FIXEDWING) || defined(SINGLECOPTER)|| defined(DUALCOPTER)
...
#if defined (AIRPLANE) || defined(SINGLECOPTER)|| defined(DUALCOPTER) && defined(PROMINI) 
