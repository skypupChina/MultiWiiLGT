...
namespace MultiWiiWinGUI
{
    ...
    public partial class mainGUI : Form
    {
        ...
        // 默认位置改为成都。 Dolphin 2023.12.06
        static PointLatLng copterPos = new PointLatLng(30.7421, 103.9635);       //Just the corrds of my flying place
        ...
        private void mainGUI_Load(object sender, EventArgs e)
        {
            ...
            MainMap.Manager.Mode = AccessMode.ServerAndCache;
            // 改为 Ping www.bing.com. Dolphin 2023.12.06
            // (!Stuff.PingNetwork("pingtest.com"))
            if (!Stuff.PingNetwork("www.bing.com"))
            {
